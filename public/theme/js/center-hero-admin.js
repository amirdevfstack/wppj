jQuery(document).ready(function ($) {
    ...
    // Image Upload
    $('.hero-image-upload-button').click(function (e) {
        e.preventDefault();
        ...
        mediaUploader.on('select', function () {
            ...
            $('.remove-hero-image-button[data-input-id="' + inputId + '"]').show(); // Show remove button
        });
    ...
    // Remove Image
    $('.remove-hero-image-button').click(function (e) {
        e.preventDefault();
