    ...
    $('#addNewSlide').click(function() {
        var newSlideHtml = `
            <div class='brand-slide' data-index='${slideIndex}'>
                <p><input type='text' name='brands_slider_data[${slideIndex}][name]' placeholder='Brand Name'></p>
                <p><input type='text' name='brands_slider_data[${slideIndex}][description]' placeholder='Brand Description'></p>
                <p><input type='text' name='brands_slider_data[${slideIndex}][link]' placeholder='Brand Link'></p>
                <p><input type='text' name='brands_slider_data[${slideIndex}][image]' placeholder='Brand Image URL' class='image-url-field-${slideIndex}'></p>
                <p><button type='button' class='button upload_image_button' data-input='brands_slider_data[${slideIndex}][image]' data-preview-image='.image-preview-${slideIndex}'>Upload Image</button></p>
