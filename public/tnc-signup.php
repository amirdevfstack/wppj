<?php
   ...
   */
   ...
   ?>
<div class="wrapper signupBgImage container-fluid" style="background-image:url('<?php echo get_template_directory_uri() ?>/public/theme/images/bg18.jpg'); background-repeat:no-repeat;background-size:cover; margin-top:60px;" >
